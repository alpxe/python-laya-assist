...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(30, 330, 551, 20))
        self.layoutWidget.setObjectName("layoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.skinsTxt = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.resTxt = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.unpackTxt = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.antBtn = QtWidgets.QPushButton(Form)
        self.antBtn.setGeometry(QtCore.QRect(130, 5, 71, 32))
        self.antBtn.setObjectName("antBtn")
    ...
    def retranslateUi(self, Form):
        ...
        self.antBtn.setText(_translate("Form", "反选"))
