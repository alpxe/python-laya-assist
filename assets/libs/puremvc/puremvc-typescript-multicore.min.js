...
};f.prototype.getData=function(){return this.data};f.prototype.onRegister=function(){};f.prototype.onRemove=function(){};f.NAME="Proxy";return f})(c.Notifier);c.Proxy=d})(b||(b={}));window.puremvc = b;